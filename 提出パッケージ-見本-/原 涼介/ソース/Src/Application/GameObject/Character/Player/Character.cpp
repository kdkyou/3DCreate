...
void Character::Update()
{
	...
	//Math::Vector3 _dir = m_mWorld.Backward();
	//_dir.y = -1.0f;
	//KdShaderManager::Instance().WorkAmbientController().SetDirLight(_dir, { 0.3f,0.3f,0.3f });
	//
...
//const Math::Vector3& Character::SetMoveVec() const
//{
...
//		if (easing & EasingType::None)
	...
	switch (easingType)
	{
	case CharacterBase::EasingType::In:
